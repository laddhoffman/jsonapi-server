...
/**
 * This is the function you call to define resources.
 */
jsonApi.define = function(resourceConfig) {
  ...
  // Ensures the handlers use the proper numbers of input and output fields
  handlerEnforcer.wrap(resourceConfig.handlers);

  // If necessary, call the initialise method on our handlers object
  if (resourceConfig.handlers.initialise) {
    resourceConfig.handlers.initialise(resourceConfig);
  }

  // Make sure our resource has sane attribute names
